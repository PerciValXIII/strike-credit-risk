...
from exp3_homecredit.model_training.meta_learners.meta_ebm import train_meta_model_ebm
...
# --- Logging Setup ---
log_file = log_dir / "strike_homecredit_stacking_ebm.log"
logging.basicConfig(
    level=logging.INFO,
...
if __name__ == "__main__":
    ...
    with log_stage("Training Meta-Model"):
        train_meta_model_ebm(demog_preds, deq_preds, vin_preds, target_df, logger=logger)
