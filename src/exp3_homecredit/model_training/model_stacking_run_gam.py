...
from exp3_homecredit.model_training.meta_learners.meta_gam import train_meta_model_gam
...
# --- Logging Setup ---
log_file = log_dir / "strike_homecredit_stacking_gam.log"
logging.basicConfig(
    level=logging.INFO,
...
if __name__ == "__main__":
    ...
    with log_stage("Training Meta-Model"):
        train_meta_model_gam(demog_preds, deq_preds, vin_preds, target_df, logger=logger)
